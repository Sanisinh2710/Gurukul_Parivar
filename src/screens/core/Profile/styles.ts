...
export const styles = () => {
  return StyleSheet.create({
    ...
    imageView: {height: 64, width: 64},
    imageStyle: {height: '100%', width: '100%', borderRadius: 50},
    pictureUpdateIcon: {height: 20, width: 20},
    userNameView: {justifyContent: 'center', marginLeft: '5%'},
    flatlistNameView: {justifyContent: 'center', marginLeft: '5%'},
    langText: {color: COLORS.primaryColor, fontSize: 14},
    arrow: {height: 24, width: 24},
    linearGradientContainer: {height: 80, width: 80},
    modelOption: {justifyContent: 'center'},
  });
};
